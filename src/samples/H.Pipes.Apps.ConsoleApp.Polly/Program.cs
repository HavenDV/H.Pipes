                ...
                var _ = Task.Run(async () =>
                {
                    while (true)
                    {
                        try
                        {
                            ...
                            await server.WriteAsync(message ?? string.Empty, source.Token).ConfigureAwait(false);
                        }
                        catch (Exception exception)
                        {
                            OnExceptionOccurred(exception);
                ...
                var _ = Task.Run(async () =>
                {
                    while (true)
                    {
                        try
                        {
                            ...
                            await client.WriteAsync(message ?? string.Empty, source.Token).ConfigureAwait(false);
                        }
                        catch (Exception exception)
                        {
                            OnExceptionOccurred(exception);
